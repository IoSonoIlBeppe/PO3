...
public class DecoratedPlayer implements Player, Damageable {
    ...
    public void executeTurn() {
        ...
        for (int i = 0; i != 2; ++i) {
            DecoratedPlayer fieldsPlayer = CardGame.instance.getPlayer(i);
    ...
    public boolean isTarget() {
        return decorated.isTarget();
    }

    @Override
    public void setDeck(Iterator<Card> deck) {
        decorated.setDeck(deck);
    }

    @Override
    public Library getDeck() {
        return decorated.getDeck();
    }

    @Override
    public List<Card> getHand() {
        return decorated.getHand();
    }

    @Override
    public int getMaxHandSize() {
        return decorated.getMaxHandSize();
    }

    @Override
    public void setMaxHandSize(int size) {
        decorated.setMaxHandSize(size);
    }
    ...
    public List<Enchantment> getEnchantments() {
        return decorated.getEnchantments();
    }

    @Override
    public void destroy(Enchantment e) {
        decorated.destroy(e);
    }
