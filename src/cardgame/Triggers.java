...
public class Triggers {
    ...
    private class Entry {
        ...
        public Entry(int f, TriggerAction a, int d) {
            filter = f;
            action = a;
            delay = d;
        }

        public boolean equals(TriggerAction a) {
    ...
    public void register(int phaseTrigger, TriggerAction a, int delay) {
        actions.add(new Triggers.Entry(phaseTrigger, a, delay));
    }
